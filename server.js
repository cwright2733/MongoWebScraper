...
var databaseUri = "mongodb://localhost/CNNscrape";
...
app.get("/scrape", function(req, res) {
  ...
  request("https://www.cnn.com/", function(error, response, html) {
    ...
    // Load to cheerio, save to $ for a shorthand selector
    ...
    $("h4.headline-link").each(function(i, element) {
      ...
      // Using Article model, create new entry to pass result object to the entry (and the title and link)
